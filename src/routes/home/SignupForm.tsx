...
const SignupForm = forwardRef<HTMLDivElement>((props, ref: React.ForwardedRef<HTMLDivElement>) => {
    ...
    useEffect(() => {
        ...
        // @ts-ignore
        if (googleSignUpButton !== null && typeof google !== "undefined") {
            // @ts-ignore
    ...
    return (
        <div className="absolute w-full" ref={ref}>
            <form className="block" id="signup-form">
                ...
                {/* Login submit button */}
                <button type="button" className="uppercase cursor-pointer font-bold rounded-md shadow-lg px-3 py-2 bg-green-600 text-white transition-all hover:bg-green-700 hover:shadow-2xl active:bg-green-200 text-center w-full my-2" >Sign up</button>
            </form>
            ...
            <div>
                <div id="google-sign-up-button"></div>
            </div>
        </div>
    )
});
